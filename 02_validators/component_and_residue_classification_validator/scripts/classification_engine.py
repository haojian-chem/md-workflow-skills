...
def _rtp_candidates_for_residue(
    ...
    for role in sorted(roles.get(residue.residue_key, set())):
        mapped_targets.extend(terminal_mappings.get((residue.residue_name, role), []))
        ...
        unresolved.append(
            {
                ...
                "evidence": ["multiple explicit terminal template mappings"],
                "resolution_status": "PENDING_CONFIRMATION",
            }
        )
        return None, []
