...
def acquire_ccd_template(
    ...
    *,
    ...
    """Resolve a component from ordered local libraries.

    The legacy keyword arguments remain only as an internal engine adapter. No
    snapshot, cache or network access is performed.
    """
