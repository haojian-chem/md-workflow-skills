...
Archive note: this checklist belongs to the superseded Workstream / subagent / Workflow-Operation-Validator authoring model. Current multi-window startup checklist is `00_authoring/md-workflow-skill-authoring/assets/multi_window_startup_checklist.md`.
