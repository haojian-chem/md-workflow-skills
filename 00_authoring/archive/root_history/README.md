# Archived former `00_authoring/` root material
...
- 不属于 current authoring authority；
- 不进入普通 authoring startup/read list；
- 不能用于恢复当前 Runtime、Manager 或 Skill 接口；
- 仅在历史追溯、旧设计审计或明确 Legacy migration 时读取。
