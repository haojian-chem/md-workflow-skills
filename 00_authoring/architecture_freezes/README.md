...
Stage 2 的 2.3 环节结构、正式结果记录和向 2.5 交付的信息记录于 `WORKFLOW2_STAGE2_2.3_PARAMETERIZATION_MODEL_FREEZE.md`；建立参数化模型、量化计算和电荷拟合的详细科学规则分别记录于 `WORKFLOW2_STAGE2_2.3_PARAMETERIZATION_MODEL_CONSTRUCTION_FREEZE.md`、`WORKFLOW2_STAGE2_2.3_QUANTUM_CALCULATION_RULES_FREEZE.md` 和 `WORKFLOW2_STAGE2_2.3_CHARGE_FITTING_RULES_FREEZE.md`。
