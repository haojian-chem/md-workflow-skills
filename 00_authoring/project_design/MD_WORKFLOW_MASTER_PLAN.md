...
- Stage 5：Stage-level analysis planning/orchestration architecture 已冻结；不设置 `5.1`；未来 active entry 为 `05_analysis/SKILL.md`，当前正式 Stage 5 / analysis capability Skill generation 尚未获批；
